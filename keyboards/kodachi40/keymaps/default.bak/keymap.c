...
#define BSP_LW LT(_LOWER,KC_SPC)  // Tap for Backspace, hold for LOWER
#define ENT_RS LT(_RAISE,KC_ENT)  // Tap for Enter, hold for RAISE
#define SPC_RS LT(_RAISE,KC_SPC)  // Tap for Space, hold for RAISE
#define BSP_RS LT(_RAISE,KC_SPC)  // Tap for Backspace, hold for RAISE
...
#define ADJ MO(_ADJUST)  // Hold for ADJUST



enum layer_keycodes {
	DEFAULT = SAFE_RANGE, LOWER, RAISE
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	* |ESC/FN|LGUI |MENU  |LALT | ENTER/LOWER | SPACE/RAISE | RALT |RGUI |RCTRL |
	...
	[_LOWER] = KEYMAP(
		...
		_______, _______, _______, _______, _______, ADJ, _______, _______, _______),
	...
	[_RAISE] = KEYMAP(
		...
		_______, _______, _______, _______, ADJ, _______, _______, _______, _______),
	 ...
	 */
	[_FUNCTION] = KEYMAP(
		_______, KC_PGUP, KC_UP, KC_PGDN, KC_BSPC, KC_HOME, _______, KC_PGUP, KC_UP, KC_PGDN, KC_PSCR, _______, 
		_______, KC_LEFT, KC_DOWN, KC_RGHT, KC_DEL, KC_END, KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, _______, 
		_______, KC_VOLU, KC_MUTE, KC_VOLD, _______, _______, KC_END, KC_MPLY, KC_MPRV, KC_MNXT, _______, _______, 
	...
	[_ADJUST] = KEYMAP(
		...
		_______, _______, _______, KC_INS, _______, _______, RGB_MOD, RGB_HUI, RGB_VAI, RGB_SAI, _______, 
